package nl.michielgraat.adventofcode2024;
...
public class DailySetup {
    ...
    private static void createSrc(int day) throws IOException {
        Path dirPath = Paths.get("src", "nl", "michielgraat", "adventofcode2024", getSrcDirectory(day));
        Path filePath = Paths.get("src", "nl", "michielgraat", "adventofcode2024", getSrcDirectory(day), getSrcFile(day));
        Path skelPath = Paths.get("src", "nl", "michielgraat", "adventofcode2024", "skeleton", "Skeleton.java");
